...
-- Add new columns for enhanced transaction management
...
-- Sample data for testing (with categories)
...
(1, 2, 50.00, NOW() - INTERVAL 1 DAY, 'COMPLETED', 'Grocery shopping at Walmart', 'TRANSFER', 'TXN001', 'GROCERIES', 'Walmart'),
(1, NULL, 25.00, NOW() - INTERVAL 2 DAY, 'COMPLETED', 'Gas at Shell Station', 'WITHDRAWAL', 'TXN002', 'GAS', 'Shell'),
(2, 1, 100.00, NOW() - INTERVAL 3 DAY, 'COMPLETED', 'Dinner at McDonalds', 'TRANSFER', 'TXN003', 'DINING', 'McDonalds'),
(1, NULL, 1200.00, NOW() - INTERVAL 5 DAY, 'COMPLETED', 'Monthly rent payment', 'WITHDRAWAL', 'TXN004', 'BILLS', 'Property Management'),
(2, NULL, 75.50, NOW() - INTERVAL 7 DAY, 'COMPLETED', 'Amazon purchase', 'WITHDRAWAL', 'TXN005', 'SHOPPING', 'Amazon');